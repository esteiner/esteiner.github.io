...
## Purpose
Defines how the free-text filter shared by the search, cellar, cellarwork and order pages matches products, including the explicit "bis <year>" drinking-window query.
## Requirements
